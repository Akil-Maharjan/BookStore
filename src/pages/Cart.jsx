...
export default function Cart() {
  ...
  const subtotal = items.reduce((sum, i) => sum + (i.book?.price_npr || 0) * i.quantity, 0);
      ...
      <Box sx={{ position: 'relative', zIndex: 1 }}>
        ...
        {items.length === 0 ? (
          ...
          >
            ...
            >
              {items.map((i, index) => (
                <Box
                  ...
                  sx={{
                    display: 'grid',
                    gridTemplateColumns: { xs: '1fr', sm: '1.4fr auto auto auto' },
                    alignItems: 'center',
                    gap: { xs: 2.5, sm: 3 },
                    px: { xs: 2.5, sm: 4 },
                    py: { xs: 2.5, sm: 3 },
                ...
                >
                  ...
                  >
                    ...
                    <Box>
                      ...
                      <Typography
                        variant="body2"
                        sx={{ color: 'rgba(148, 163, 184, 0.85)', fontFamily: 'poppins' }}
                      >
                  ...
                  >
                    <IconButton
                      ...
                      sx={quantityButtonSx}
                      onClick={() =>
                        updateMut.mutate({ bookId: i.book._id, quantity: Math.max(0, i.quantity - 1) })
                      }
                    >
                    ...
                    <Typography
                      variant="h6"
                      sx={{ fontFamily: 'poppins', fontWeight: 500, minWidth: 24, textAlign: 'center' }}
                    >
                      {i.quantity}
                    </Typography>
                    <IconButton
                      size="small"
                      sx={quantityButtonSx}
                      onClick={() => updateMut.mutate({ bookId: i.book._id, quantity: i.quantity + 1 })}
                    >
            ...
            <Paper
              sx={{
                background: 'linear-gradient(160deg, rgba(17, 24, 39, 0.92), rgba(15, 23, 42, 0.88))',
                borderRadius: 4,
                border: '1px solid rgba(148, 163, 184, 0.12)',
                boxShadow: '0 24px 40px -24px rgba(15, 23, 42, 0.8)',
                p: { xs: 3, md: 4 },
            ...
            >
              <Typography
                variant="h6"
                sx={{ fontFamily: 'poppins', fontWeight: 600, color: '#F9FAFB' }}
              >
                Order summary
              </Typography>
              ...
              <Box sx={{ borderTop: '1px solid rgba(148, 163, 184, 0.12)', pt: 3 }}>
                <Box
                  sx={{
                    display: 'flex',
                    alignItems: 'center',
                ...
                >
                  ...
                  <Typography variant="h5" sx={{ fontWeight: 600, color: '#F9FAFB' }}>
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => {navigate('/checkout'), scrollTo({top: 0, behavior: 'smooth'})}}
                  sx={{
