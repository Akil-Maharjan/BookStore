...
export default function Books() {
  ...
  return (
    <div className="max-w-[1550px] overflow-x-hidden mx-auto px-4 py-8">
      ...
      <div className="grid max-w-full w-full place-items-center place-self-center sm:place-self-auto mb-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-8 gap-x-4 relative z-10">
