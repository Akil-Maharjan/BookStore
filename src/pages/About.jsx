        ...
        <div className="max-w-[96rem] mx-auto px-4 h-full flex items-center">
          <div className="w-full flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16">
            ...
            <RevealOnScroll
              direction="left"
              delay={0.1}
              className="flex-1 w-full md:max-w-3xl lg:max-w-2xl text-center"
            >
              <h2 className="text-white text-4xl md:text-4xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-tight drop-shadow-sm">
                About BookStore
              </h2>
              <p className="mt-6 text-white/90 text-lg xl:text-2xl max-w-3xl mx-auto md:mx-0">
                We connect readers with stories that inspire, educate, and
                entertain. From timeless classics to the latest releases,
                discover your next great read.
              </p>
              <p className="mt-4 text-white/90 text-lg xl:text-2xl max-w-3xl mx-auto md:mx-0">
                Our mission: a delightful shopping experience with fast search,
                personalized recommendations, and a vibrant community of book
                lovers.
              </p>
              <div className="mt-8 flex flex-wrap justify-center md:justify-center gap-4">
                <div className="rounded-xl px-4 py-3 bg-white/90 text-slate-900 font-semibold">
                  Curated genres
                </div>
                <div className="rounded-xl px-4 py-3 bg-white/90 text-slate-900 font-semibold">
                  Bestsellers
