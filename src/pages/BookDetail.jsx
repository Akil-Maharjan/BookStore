...
export default function BookDetail() {
  ...
  const handleSubmitReview = () => {
    ...
    reviewMut.mutate({
      ...
      reviewId: isEditing ? editingReviewId : undefined,
    });
  };
  ...
  if (!book)
    return <div className="max-w-[96rem] mx-auto px-4 py-8">Not found</div>;
  ...
  return (
    <div className="max-w-[96rem] xl:pr-20 lg:pr-10 md:pr-8 pr-4  mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 relative z-10 md:grid-cols-2 gap-6">
        ...
        <div>
          <h1 className="text-4xl font-poppins md:text-5xl font-bold mb-2">
            {book.title}
          </h1>
          ...
          <div className="text-3xl md:text-4xl font-inter font-bold mt-4">
            Rs. {book.price_npr}
          </div>
          <p className="mt-3 leading-relaxed text-2xl font-poppins">
            {book.description}
          </p>
          <div className="flex items-center gap-3 mt-4">
            ...
            <input
              ...
              className="w-24 rounded border border-white/20 bg-slate-900 px-3 py-2"
            />
            <Motion.button
              type="button"
      ...
      <h2 className="text-2xl font-poppins relative z-10 font-semibold mb-3">
        Reviews
      </h2>
      ...
      <div className="rounded border border-white/10 bg-slate-900 p-3 mt-4 relative z-10">
        ...
        <div className="flex flex-col gap-2  sm:items-start">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-poppins text-white/70">
              {rating}/5
            </span>
          </div>
          <textarea
          ...
          <div className="flex flex-col font-poppins sm:flex-row gap-2 sm:items-center">
            ...
            >
              <p className="font-poppins font-semibold border border-white/20 flex gap-3 bg-slate-900 px-3 py-2">
                <Motion.span
                  animate={reviewIconControls}
                  style={{ display: "inline-block", transformOrigin: "center" }}
                >
                  ✍️
                </Motion.span>
                {reviewMut.isPending ? "Submitting…" : submitLabel}
              </p>
            </Motion.button>
            {isEditing && (
              <button
