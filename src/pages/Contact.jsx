        ...
        <div className="max-w-[96rem] mx-auto px-6 h-full flex items-center">
          <div className="w-full flex flex-col-reverse lg:flex-row-reverse items-center gap-8 md:gap-12 lg:gap-16">
            ...
            <RevealOnScroll
              direction="right"
              delay={0.1}
              className="flex-1 w-full max-w-[40rem] rounded-xl bg-slate-900 p-10 text-center md:text-left"
            >
              <span className="text-sm uppercase tracking-[0.4em] text-white/60">
                Get in touch
              </span>
              <h2 className="mt-3 text-4xl font-extrabold xl:text-[56px] lg:text-[48px] md:text-[30px] sm:text-[36px] host-grotesk">
                We&apos;d love to hear from you
              </h2>
              <p className="mt-4 host-grotesk max-w-xl xl:text-lg lg:text-md sm:text-lg text-lg text-white/75">
                Share your questions, feedback, or partnership ideas. Our team
            ...
            <RevealOnScroll
              direction="left"
              className="flex-1 w-full flex items-start md:items-center justify-center lg:justify-end"
            >
              <img
