        ...
        <div className="relative  z-10 mx-auto max-w-screen-2xl px-6 py-10 lg:px-12">
          <div className="grid gap-12 lg:grid-cols-[1.6fr_repeat(3,minmax(0,1fr))]">
            <div className="space-y-4 ">
              <div>
                ...
                <p className="mt-3 max-w-md text-sm text-neutral-400">
                  Discover your next great read with curated recommendations,
                  personalized shelves, and a vibrant community of book lovers.
                </p>
              </div>
            ...
            <nav aria-label="Explore" className="space-y-4 text-sm">
              <h3 className="font-semibold  uppercase tracking-wide text-neutral-200">
                Explore
              </h3>
              <ul className="space-y-3  text-neutral-400">
                <li>
                  <a className="transition hover:text-white" href="#popular">
                    Popular Titles
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a className="transition hover:text-white" href="#authors">
                    Authors
                  </a>
                </li>
                <li>
            ...
            <nav aria-label="Support" className="space-y-4 text-sm">
              ...
              <ul className="space-y-3 text-neutral-400">
                ...
                <li>
                  <a className="transition hover:text-white" href="#shipping">
                    Shipping & Returns
                  </a>
                </li>
                <li>
            ...
            <div className="space-y-4 text-sm">
              ...
              <p className="text-neutral-400">
                Join our newsletter for fresh releases, staff picks, and
          ...
          <div className="mt-16 flex flex-col gap-4 border-t border-white/5 pt-6 text-xs text-neutral-500 sm:flex-row sm:items-center sm:justify-between">
            <p>
              &copy; {new Date().getFullYear()} BookStore. Crafted with passion
